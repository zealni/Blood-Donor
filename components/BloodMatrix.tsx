...
const bloodCompatibilityData: Record<string, BloodGroupInfo> = {
  "O-": {
    ...
    receiveFrom: ["O-"],
    descriptionId: "Pendonor Universal. Golongan darah Anda dapat didonorkan ke semua pasien golongan darah lainnya. Namun, jika Anda memerlukan transfusi, Anda hanya dapat menerima dari golongan O-.",
    descriptionEn: "Universal donor. Your blood type can be donated to patients with all other blood types. However, if you need a transfusion, you can only receive from O-."
  },
  "O+": {
    name: "O+",
    giveTo: ["O+", "A+", "B+", "AB+"],
    receiveFrom: ["O+", "O-"],
    descriptionId: "Golongan darah paling umum. Sangat berharga untuk membantu mendonorkan darah ke lebih dari 80% populasi yang bergolongan darah rhesus positif.",
    descriptionEn: "The most common blood type. Very valuable for donating blood to more than 80% of the population with rhesus-positive blood."
  },
  "A-": {
    name: "A-",
    giveTo: ["A-", "A+", "AB-", "AB+"],
    receiveFrom: ["A-", "O-"],
    descriptionId: "Golongan darah yang tergolong langka. Sangat dicari untuk membantu pasien A- maupun golongan darah campuran AB-.",
    descriptionEn: "A relatively rare blood type. Highly needed to help A- patients and mixed AB- blood type patients."
  },
  "A+": {
    name: "A+",
    giveTo: ["A+", "AB+"],
    receiveFrom: ["A+", "A-", "O+", "O-"],
    descriptionId: "Golongan darah yang sangat krusial dalam stok harian rumah sakit. Memiliki kontribusi besar bagi penanganan pasien rhesus positif.",
    descriptionEn: "A blood type that is crucial for daily hospital stock. It greatly contributes to treating rhesus-positive patients."
  },
  "B-": {
    name: "B-",
    giveTo: ["B-", "B+", "AB-", "AB+"],
    receiveFrom: ["B-", "O-"],
    descriptionId: "Sangat langka dan penting. Menjadi penyelamat bagi pasien B- dan AB- yang menghadapi situasi medis mendesak.",
    descriptionEn: "Very rare and important. It can be life-saving for B- and AB- patients facing urgent medical situations."
  },
  "B+": {
    name: "B+",
    giveTo: ["B+", "AB+"],
    receiveFrom: ["B+", "B-", "O+", "O-"],
    descriptionId: "Golongan darah yang penting untuk mencukupi kebutuhan darah pasien bergolongan B+ dan AB+.",
    descriptionEn: "An important blood type for meeting the needs of B+ and AB+ patients."
  },
  "AB-": {
    name: "AB-",
    giveTo: ["AB-", "AB+"],
    receiveFrom: ["AB-", "A-", "B-", "O-"],
    descriptionId: "Golongan darah paling langka kedua di dunia. Ketersediaan pendonor AB- sangat menentukan keselamatan pasien bergolongan serupa.",
    descriptionEn: "The second rarest blood type in the world. The availability of AB- donors is vital for patients with the same blood type."
  },
  "AB+": {
    name: "AB+",
    giveTo: ["AB+"],
    receiveFrom: ["O-", "O+", "A-", "A+", "B-", "B+", "AB-", "AB+"],
    descriptionId: "Penerima Universal. Anda dapat menerima transfusi darah dari golongan darah manapun secara aman, namun Anda hanya bisa mendonorkan darah Anda ke sesama pemilik AB+.",
    descriptionEn: "Universal recipient. You can safely receive blood transfusions from any blood type, but you can only donate your blood to other AB+ recipients."
  }
};
...
export default function BloodMatrix() {
  ...
  return (
    <section id="blood-matrix" data-no-translate="true" className="w-full pt-12 pb-24 bg-slate-50/50 dark:bg-slate-950/20 border-t border-slate-200 dark:border-slate-800/80 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs font-bold uppercase tracking-wider text-primary bg-primary/10 px-3.5 py-1.5 rounded-full">
            {language === "en" ? "Medical Education" : "Edukasi Medis"}
          </span>
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white mt-6">
            {language === "en" ? "Blood Type Compatibility" : "Kecocokan Golongan Darah"}
          </h2>
          <p className="text-slate-500 dark:text-slate-400 mt-4 text-base md:text-lg">
            {language === "en"
              ? "Learn who can receive your donation, and who you can receive transfusion help from."
          ...
          <div className="lg:col-span-2 flex flex-col">
            <div className="glass dark:bg-slate-900/60 p-8 rounded-[2.5rem] border border-slate-200/60 dark:border-slate-800 shadow-xl relative overflow-hidden h-full flex flex-col justify-between">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-extrabold text-lg text-slate-900 dark:text-white">
                    {language === "en" ? `Blood Type Details ${selectedType}` : `Detail Golongan Darah ${selectedType}`}
                  </h3>
                  <p className="text-xs font-medium text-slate-400">
                    Rhesus {selectedType.includes("+")
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-6">
                {language === "en" ? selectedInfo.descriptionEn : selectedInfo.descriptionId}
              </p>
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                    ...
                    {language === "en" ? "Can Donate To:" : "Bisa Mendonorkan Ke:"}
                  </h4>
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                    ...
                    {language === "en" ? "Can Receive From:" : "Bisa Menerima Donor Dari:"}
                  </h4>
                  <div className="flex flex-wrap gap-2">
            ...
            <div className="glass dark:bg-slate-900/60 p-8 rounded-[2.5rem] border border-slate-200/60 dark:border-slate-800 shadow-xl h-full flex flex-col justify-between">
              <div className="flex justify-between items-center mb-6">
                <h3 className="font-extrabold text-base md:text-lg text-slate-800 dark:text-slate-200">
                  {language === "en" ? "Choose Your Blood Type" : "Pilih Golongan Darah Anda"}
                </h3>
                <span className="text-xs font-medium text-slate-400 flex items-center gap-1">
                  <Info className="w-3.5 h-3.5" />
                  {language === "en" ? "Tap a blood type" : "Sentuh golongan darah"}
                </span>
              </div>
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">
                  {language === "en" ? "Compatibility Visualization" : "Visualisasi Kecocokan Kompatibilitas"}
                </h4>
                      ...
                      >
                        ...
                        {(canGive || canReceive) && !isSelected && (
                          <span className="text-[8px] font-medium uppercase tracking-tighter mt-0.5">
                            {canGive && canReceive 
                              ? (language === "en" ? "Donate & Receive" : "Donor & Terima") 
                              : canGive 
                                ? (language === "en" ? "Recipient" : "Penerima") 
                                : (language === "en" ? "Donor" : "Pendonor")}
                          </span>
                        )}
                      </div>
                    );
                ...
                <div className="flex flex-wrap gap-4 mt-6 text-[10px] font-bold text-slate-400 uppercase tracking-wide justify-center">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>{language === "en" ? "Both (Two-Way)" : "Dua-duanya (Dua Arah)"}</span>
                  </div>
                </div>
              </div>
            </div>
