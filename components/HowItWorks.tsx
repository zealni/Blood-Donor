...
const steps: Step[] = [
  {
    ...
    description: "Pemohon membuat permintaan darurat di sistem, memasukkan golongan darah, rumah sakit, dan jumlah kantong.",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-4 text-base md:text-lg">
            Kami memangkas rantai pencarian donor tradisional yang lambat dengan sistem otomatisasi berbasis geolokasi waktu nyata.
          </p>
        </div>
