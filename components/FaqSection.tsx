...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "Keamanan Anda adalah prioritas kami. Kami menggunakan sistem RLS (Row Level Security) database dan mekanisme Anonymous Handshake. Kontak WhatsApp atau nomor telepon Anda tidak akan pernah dipublikasikan di peta atau dashboard publik. Nomor tersebut hanya akan dienkripsi dan dikirimkan secara pribadi ke pemohon setelah Anda mengklik tombol 'Terima Permintaan' secara sadar dan sukarela.",
  },
  {
...
export default function FaqSection() {
  ...
  return (
    <section className="w-full py-24 bg-slate-50/50 dark:bg-slate-950/20 border-t border-slate-200 dark:border-slate-800/80 relative overflow-hidden">
