...
function LoginForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Load existing account if registered, otherwise create mock session
      const storedUsers = localStorage.getItem("registered_users");
      let fullName = "Pengguna BloodConnect";
      let bloodType = "O";
      let rhesus = "+";
      let lastDonation = "";
      ...
      if (storedUsers) {
        try {
          ...
          if (foundUser) {
            ...
            rhesus = foundUser.rhesus;
            lastDonation = foundUser.lastDonation || "";
          }
        } catch (e) {
          console.error(e);
        }
      ...
      // Force refreshing server components
      router.refresh();
    }, 1000);
  };
  ...
  return (
    <div className="w-full max-w-md z-10">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm">Masuk untuk mengakses dashboard donor Anda</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <a href="#" className="text-xs text-primary hover:underline font-bold">Lupa Password?</a>
            </div>
            <div className="relative">
