...
• Koordinat GPS perangkat Anda (hanya saat menggunakan fitur Peta, dengan izin eksplisit)
...
• Menampilkan statistik donasi anonim di Papan Peringkat
...
• Menonaktifkan lokasi tidak menghapus akun Anda, namun membatasi fungsionalitas Peta`,
  },
  {
    icon: <Lock className="w-5 h-5" />,
    title: "4. Proteksi Data Kontak (Persetujuan Anonim)",
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-br from-blue-50 via-white to-slate-50 border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-6 py-16 text-center">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto text-left">
            {[
              { icon: "🔒", title: "Tidak Menjual Data", desc: "Kami tidak pernah menjual data Anda" },
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mt-10 bg-gradient-to-r from-blue-50 to-slate-50 rounded-3xl border border-blue-100 p-8 text-center">
          <h3 className="text-lg font-extrabold text-slate-900 mb-2">Hubungi Petugas Perlindungan Data Kami</h3>
